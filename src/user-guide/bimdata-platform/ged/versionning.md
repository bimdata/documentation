...
La plateforme BIMData propose une fonctionnalité d'historique de version pour assurer un suivi rigoureux des évolutions de vos fichiers.
...
* Téléversez la nouvelle version du fichier en cliquant sur le bouton **"Ajouter une nouvelle version"**.
