...
The BIMData Viewer displays 3D models, plans and point clouds in a web page.
This guide takes you from an empty file to a model running in your browser.

No account needed for the first step. Count about 15 minutes for the whole page.
...
**Other formats.** The same viewer handles more than IFC. Each format is handled
by its own native built-in viewer, and interactions include **display**,
**navigation**, **measurement** and **annotation**. Pass the relevant model ID
