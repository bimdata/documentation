...
The Drawing Tools plugin is disabled by default. To enable it, add the folowing entry into the `plugins` property object of the [`makeBimdataViewer`](#native-plugins) function:
